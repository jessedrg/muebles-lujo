...
const CATEGORIES = [
  { slug: 'sofas-lujo', name: { es: 'Sofás', en: 'Sofas', de: 'Sofas', fr: 'Canapés', it: 'Divani', pt: 'Sofás', nl: 'Banken', pl: 'Sofy' } },
  { slug: 'mesas-comedor', name: { es: 'Mesas', en: 'Tables', de: 'Tische', fr: 'Tables', it: 'Tavoli', pt: 'Mesas', nl: 'Tafels', pl: 'Stoły' } },
  { slug: 'sillones-diseno', name: { es: 'Sillones', en: 'Armchairs', de: 'Sessel', fr: 'Fauteuils', it: 'Poltrone', pt: 'Poltronas', nl: 'Fauteuils', pl: 'Fotele' } },
  { slug: 'camas-premium', name: { es: 'Camas', en: 'Beds', de: 'Betten', fr: 'Lits', it: 'Letti', pt: 'Camas', nl: 'Bedden', pl: 'Łóżka' } },
];
